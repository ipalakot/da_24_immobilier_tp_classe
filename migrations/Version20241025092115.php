 ...
 */
final class Version20241025092115 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, adresse LONGTEXT NOT NULL, images VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, surface DOUBLE PRECISION NOT NULL, prix INT NOT NULL, owner VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, gestionnaire VARCHAR(255) NOT NULL, agence VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
